...
// Wrapped in a private module so `#![allow(missing_docs)]` can suppress the
// `pest_derive`-generated `Rule` enum's undocumented variants without
// affecting the rest of the crate.
mod mpl_parser_impl {
    #![allow(missing_docs)]
