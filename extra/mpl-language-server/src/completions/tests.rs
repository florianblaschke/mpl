...
#[test_case("ds:metric | align using #"                  => Some("align_functions")  ; "align using suggests functions")]
...
#[test_case("`dev.metrics`:http_requests_total\n| align #", &["over"]     ; "align initially excludes over")]
...
#[test_case("ds:metric | bucket to 42s #",          &["using"]    ; "bucket after to only using")]
